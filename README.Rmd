...
The processed building dataset is stored in the MySQL database using this following piece which stores the table `buildings` with a `buildings_DA_dict` table. The latter will be used to download subsets of our building dataset to be downloaded using dissemination area IDs. 
